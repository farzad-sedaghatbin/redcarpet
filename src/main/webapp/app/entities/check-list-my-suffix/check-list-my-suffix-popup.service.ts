...
@Injectable()
export class CheckListMySuffixPopupService {
            ...
            if (id) {
                this.checkListService.find(id)
                    .subscribe((checkListResponse: HttpResponse<CheckListMySuffix>) => {
                        const checkList: CheckListMySuffix = checkListResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.checkListModalRef(component, new CheckListMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    checkListModalRef(component: Component, checkList: CheckListMySuffix): NgbModalRef {
